...
contract ApiInfo is TransferEther {
    ...
    function createNewProvableInfo(address _user) public returns (address){
        // string memory _name, string memory _param1, string memory _param2, uint _cost, address _OAR, address _owner, address _user
        ProvableInfo provableApi = (new ProvableInfo)(name, provable_query_param1, provable_query_param2, cost, oar, owner, _user);
